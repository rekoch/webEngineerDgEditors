...
- [Blog Page mit CSS](./css/blogpage/intro.md)
    ...
    - [🏷️ Rubrik](./css/blogpage/rubrik.md)
    - [🔘 Buttons](./css/blogpage/buttons.md)
    - [❤️ like Bereich](./css/blogpage/likes.md)
    - [🎯 CSS Variablen](./css/blogpage/variables.md)
...
- [🧠 Blog Page Intelligence](./javascript/blogPageIntelligence/intro.md)
    - [🤖 Table auto design](./javascript/blogPageIntelligence/table.md)
    - [🛎️ Push the button](./javascript/blogPageIntelligence/buttons.md)
    - [⛓️‍💥 connect the backend](./javascript/blogPageIntelligence/backendConnect.md)
    - [❤️‍🩹 like Funktion wiederherstellen](./javascript/blogPageIntelligence/likes.md)
    - [🚓 follow Funktion wiederherstellen](./javascript/blogPageIntelligence/follow.md)
    - [💝 wrap it up](./javascript/blogPageIntelligence/wrapUp.md)